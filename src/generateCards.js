function generateManager(manager) {
  ...
  <div class = "card-header mt-3 mb-3">Name: ${manager.getRole()}</div>
...
function generateEngineer(engineer) {
  return `
                <div class="col-sm-2">
  <div class = "card text-white bg-dark style = "width: 20rem ">
  <div class = "card-header mt-3 mb-3">Name: ${engineer.getRole()}</div>
  <ul class = "list-group list-group-flush" >
...
function generateIntern(intern) {
  return `
                ...
                <div class="col-sm-2">
  <div class = "card text-white bg-dark style = "width: 20rem ">
  <div class = "card-header mt-3 mb-3">Name: ${intern.getRole()}</div>
  <ul class = "list-group list-group-flush" >
